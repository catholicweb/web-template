 ...
 */
export function generateThemeCSS(rawTheme = {}, skipFonts = false) {
...
${skipFonts? '' : buildGoogleFontsImport(titleFont, bodyFont)}
@import "tailwindcss";
${skipFonts? '' : buildLocalFontFace(titleFont, bodyFont)}
